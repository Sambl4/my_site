...
function yellowed_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['yellowed_settings']['social']['display'] = array(
    ...
    $form['yellowed_settings']['social']['Reserve_A1'] = array(
    '#type' => 'fieldset',
    '#title' => t('Reserve_A'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );  
  $form['yellowed_settings']['social']['Reserve_A1']['facebook'] = array(
    '#type' => 'textfield',
    '#title' => t('Reserve_A URL'),
    '#default_value' => theme_get_setting('facebook', 'yellowed'),
    '#description'   => t("Enter your Reserve_A page URL. example:: http://www.xyz.com"),
  );
    $form['yellowed_settings']['social']['Print'] = array(
    '#type' => 'fieldset',
    '#title' => t('Print'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );  
   $form['yellowed_settings']['social']['Print']['twitter'] = array(
    '#type' => 'textfield',
    '#title' => t('Print URL'),
    '#default_value' => theme_get_setting('twitter', 'yellowed'),
    '#description' => t("Enter your Print URL. example:: http://www.xyz.com"),
  );
  ...
  $form['yellowed_settings']['social']['linkedin1']['linkedin'] = array(
    ...
    $form['yellowed_settings']['social']['Contacts1'] = array(
    '#type' => 'fieldset',
    '#title' => t('Contacts'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  ); 
    $form['yellowed_settings']['social']['Contacts1']['vimeo'] = array(
    '#type' => 'textfield',
    '#title' => t('Contacts URL'),
    '#default_value' => theme_get_setting('vimeo', 'yellowed'),
    '#description'   => t("Enter your Vimeo Profile URL. example:: http://www.xyz.com"),
  );
    $form['yellowed_settings']['social']['Reserve_B1'] = array(
    '#type' => 'fieldset',
    '#title' => t('Reserve_B'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  ); 
    $form['yellowed_settings']['social']['Reserve_B1']['youtube'] = array(
    '#type' => 'textfield',
    '#title' => t('Reserve_B URL'),
