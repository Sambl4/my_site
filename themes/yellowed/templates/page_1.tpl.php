 ...
 <?php if ($display): ?>
         <div id="socialbar">
			 <div class="social-wrapper">
                <ul class="social">
                <?php $Foptions['attributes'] = array('target' => '_blank','title' =>'Souvenir'); ?>
...
<div id="footer">
 ...
 <?php if ($footer_copyright || $footer_developed): ?>
  ...
  <?php if ($footer_developed): ?>
    <p class="credits"> 
    <a href="<?php print ($footer_developedby_url); ?> " target="_blank"><?php print ($footer_developedby); ?></a> & <a href="http://drupalstyle.ru/">Drupal Шаблоны</a></p>
  <?php endif; ?>
<?php endif; ?>
    <div class="clear"></div>
  </div>
